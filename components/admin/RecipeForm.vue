<template>
  <div class="container">
    <div class="row g-3 justify-content-md-center">
      ...
      <base-text-area v-model="newRecipe.description">
        <label action="desc" class="form-label">Recipe Description</label>
      </base-text-area>
...
export default {
  ...
  mounted() {
    ...
    if (this.recipes) {
      this.ingredientCount = this.recipes.ingredients.length + 1;
      this.directionCount = this.recipes.directions.length + 1;
    }
  },
};
</script>
